...
class Ui_featureFinder(object):
    def setupUi(self, featureFinder):
        ...
        sizePolicy6.setHeightForWidth(self.controls_frame.sizePolicy().hasHeightForWidth())
        self.controls_frame.setSizePolicy(sizePolicy6)
        ...
        self.gridLayout_3.addWidget(self.feature_max_size_slider, 6, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.blob_min_size_slider, 10, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.feature_max_size_label, 6, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.blob_subheader_label, 8, 0, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.feature_max_size_spin, 6, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.blob_min_size_spin, 10, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.blob_max_size_label, 11, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.circularity_slider, 9, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.blob_max_size_slider, 11, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.gauss_blur_spin, 4, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.feature_min_size_spin, 5, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.gauss_blur_label, 4, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.pixel_threshold_label, 2, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.feature_min_size_slider, 5, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.gauss_blur_slider, 4, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.circularity_spin, 9, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        sizePolicy6.setHeightForWidth(self.pixel_threshold_spin.sizePolicy().hasHeightForWidth())
        self.pixel_threshold_spin.setSizePolicy(sizePolicy6)
        ...
        self.gridLayout_3.addWidget(self.pixel_threshold_spin, 2, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.blob_max_size_spin, 11, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.circularity_label, 9, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.feature_min_size_label, 5, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        sizePolicy7.setHeightForWidth(self.pixel_threshold_slider.sizePolicy().hasHeightForWidth())
        self.pixel_threshold_slider.setSizePolicy(sizePolicy7)
        ...
        self.gridLayout_3.addWidget(self.pixel_threshold_slider, 2, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_3.addWidget(self.blob_min_size_label, 10, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)

        self.hough_threshold_label = QLabel(self.controls_frame)
        ...
        self.gridLayout_3.addWidget(self.hough_threshold_label, 3, 0, 1, 1, Qt.AlignmentFlag.AlignVCenter)

        self.hough_threshold_slider = QSlider(self.controls_frame)
        self.hough_threshold_slider.setObjectName(u"hough_threshold_slider")
        sizePolicy7.setHeightForWidth(self.hough_threshold_slider.sizePolicy().hasHeightForWidth())
        self.hough_threshold_slider.setSizePolicy(sizePolicy7)
        ...
        self.gridLayout_3.addWidget(self.hough_threshold_slider, 3, 1, 1, 1, Qt.AlignmentFlag.AlignVCenter)

        self.hough_threshold_spin = QSpinBox(self.controls_frame)
        self.hough_threshold_spin.setObjectName(u"hough_threshold_spin")
        sizePolicy6.setHeightForWidth(self.hough_threshold_spin.sizePolicy().hasHeightForWidth())
        self.hough_threshold_spin.setSizePolicy(sizePolicy6)
        self.hough_threshold_spin.setMinimumSize(QSize(100, 0))
        self.hough_threshold_spin.setMaximum(255)

        self.gridLayout_3.addWidget(self.hough_threshold_spin, 3, 2, 1, 1, Qt.AlignmentFlag.AlignVCenter)
    ...
    def retranslateUi(self, featureFinder):
        ...
        self.rect_detection_label.setText(QCoreApplication.translate("featureFinder", u"Detection Type:", None))
...
#endif // QT_CONFIG(tooltip)
        self.crosshair_detection_check.setText(QCoreApplication.translate("featureFinder", u"Rectangular (On) / Crosshair (Off)", None))
#if QT_CONFIG(tooltip)
        self.pixel_threshold_spin.setToolTip(QCoreApplication.translate("featureFinder", u"Threshold value for edge detection", None))
#endif // QT_CONFIG(tooltip)
